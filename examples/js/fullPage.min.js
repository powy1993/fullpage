...
b&&(" "===f||""===f?d.splice(c,1):d[c]=f);d.length?a.className=d.join(" "):(a.removeAttribute("class"),a.removeAttribute("className"))}};I&&(L=function(a,b){var f=u[b].className;q(u[a],"active"," ");u[b].className=""===f?"active":f+" active"});x=function(a){var g=z,f,c;if(!(t||a===b||a>=H||0>a)){t=!0;for(c in w)X[c](w[c],b,a);g+=""===h?20:0;f=b;b=a;I&&L(f,b);setTimeout(function(){e[a].className+=" slide"},g);setTimeout(function(){F[a][h+"TransitionDuration"]=C+"ms"},20);setTimeout(function(){q(e[f],
...
U;break;case "touch"===a:if(!D||!y)break;(function(){var a=w.transform.scale[0],f=w.transform.scale[1]-a,c=w.transform.rotate[0],d=w.transform.rotate[1]-c,l=w.opacity[0],u=w.opacity[1]-l,v,x,y,z,G,r={},A=!1,n,p,D,M,N,E,J;"Y"===w.transform.translate?(D=function(){n=F[b-1];p=F[b+1];n&&(n[h+"TransitionDuration"]="0ms",n[h+"Transform"]="translate(0,-"+s+"px) translateZ(0)",n[h+"TransformOrigin"]="50% 100%",e[b-1].className+=" swipe");p&&(p[h+"TransitionDuration"]="0ms",p[h+"Transform"]="translate(0,"+
...
setTimeout(function(){q(e[b+d],"slide","");setTimeout(function(){t=!1},50)},c)},N=function(a,d){var c=b+d,f=~~(C/1.5),g=e[b-d];g&&q(g,"swipe","");0>c||c>H-1?setTimeout(function(){t=!1},50):(I&&L(b,c),a.opacity=1,q(e[c],"swipe","slide"),a[h+"TransitionDuration"]=f+"ms",a[h+"Transform"]="translate(0,0) translateZ(0)",setTimeout(function(){q(e[b],"current","");q(e[c],"slide","current");b=c;k.callback&&k.callback(b,e[b]);setTimeout(function(){t=!1},50)},f))}):(D=function(){n=F[b-1];p=F[b+1];n&&(n[h+"TransitionDuration"]=
"0ms",n[h+"Transform"]="translate(-"+m+"px,0) translateZ(0)",n[h+"TransformOrigin"]="100% 50%",e[b-1].className+=" swipe");p&&(p[h+"TransitionDuration"]="0ms",p[h+"Transform"]="translate("+m+"px,0) translateZ(0)",p[h+"TransformOrigin"]="0 50%",e[b+1].className+=" swipe")},E=function(b){var e=Math.abs(b.x/m),K=" scale("+(a+f*e)+") rotate("+(c+d*e)+"deg)";n&&0<b.x&&(console.log(),n.opacity=l+u*e,n[h+"Transform"]="translate("+(b.x-m)+"px,0) translateZ(0)"+K);p&&0>b.x&&(p.opacity=l+u*e,p[h+"Transform"]=
"translate("+(m+b.x)+"px,0) translateZ(0)"+K)},M=function(a,c){var d=C>>1;q(e[b+c],"swipe","slide");a.opacity=1;a[h+"TransitionDuration"]=d+"ms";a[h+"Transform"]="translate("+c*m+"px,0) translateZ(0)";setTimeout(function(){q(e[b+c],"slide","");setTimeout(function(){t=!1},50)},d)},N=function(a,c){var d=b+c,f=~~(C/1.5),g=e[b-c];g&&q(g,"swipe","");0>d||d>H-1?setTimeout(function(){t=!1},50):(I&&L(b,d),q(e[d],"swipe","slide"),a.opacity=1,a[h+"TransitionDuration"]=f+"ms",a[h+"Transform"]="translate(0,0) translateZ(0)",
setTimeout(function(){q(e[b],"current","");q(e[d],"slide","current");b=d;k.callback&&k.callback(b,e[b]);setTimeout(function(){t=!1},50)},f))});v=function(a){var b=a.touches[0];a.preventDefault();1<event.touches.length||event.scale&&1!==event.scale||(r={x:b.pageX-y,y:b.pageY-z},A?J&&E(r):(J=Math.abs(r.x)>Math.abs(r.y)?"X":"Y",J=J===k.effect.transform.translate?!0:!1,A=!0))};x=function(a){var b=a.changedTouches[0];a=+new Date-G;var d;d=0;var c=!1;r={x:b.pageX-y,y:b.pageY-z};b=Math.abs(r.x);d=Math.abs(r.y);
switch(k.effect.transform.translate){case "Y":c=250>+a&&30<d||d>.3*s;d=0<r.y?-1:1;break;case "X":c=250>+a&&30<b||b>.3*m;d=0<r.x?-1:1;break;default:c=350>+a&&50<d+b||d>.3*s||b>.3*m,d=b>d?0<r.x?-1:1:0<r.y?-1:1}c&&J?-1===d?N(n,-1):N(p,1):(n&&M(n,-1),p&&M(p,1));B.removeEventListener("touchmove",v,!1);B.removeEventListener("touchend",x,!1)};B.addEventListener("touchstart",function(a){a=a.touches[0];t||(t=!0,y=a.pageX,z=a.pageY,G=+new Date,r={},A=!1,D(),B.addEventListener("touchmove",v,!1),B.addEventListener("touchend",
