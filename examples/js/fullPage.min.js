...
function(a){a=a.touches[0];t||(t=!0,s=a.pageX,u=a.pageY,A=+new Date,v={},x(),C.addEventListener("touchmove",d,!1),C.addEventListener("touchend",m,!1))},!1)})();break;case -1!==a.indexOf("nav:"):(function(){var f=a.split(":")[1],f=document.getElementById(f),e,c;s=f.children;e=s.length;c=s[b].className;if(f&&s){for(;e--;)s[e].setAttribute("data-page",e);-1===c.indexOf("active")&&(s[b].className=""===c?"active":c+" active");e=function(a){var b;a=a||window.event;a=a.target||a.srcElement;for(b=a.tagName.toLowerCase();"li"!==
b;){if("ul"===b)return;a=a.parentNode;b=a.tagName.toLowerCase()}A(+a.getAttribute("data-page"))};U(f,e,1)}})()}})(N[O]);return{thisPage:function(){return b},go:function(a){A(a)},next:function(){A(b+1)},prev:function(){A(b-1)}}}};